const LoginPage = require('../support/pages/login.pages.js');
const ActionsPage = require('../support/pages/actions.pages.js')
const LoginPageLocator = require('../support/locators/login.locators.js');
